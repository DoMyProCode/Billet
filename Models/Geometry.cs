...
namespace Billet
{
    ...
    {
        public double b_k { get; set; } = 5; // зазор между корпусом и внешним диаметром крышки в радиальном направлении
        public double b_pr { get; set; } = 11; // зазор просвета между вырезом в крышке и внутренним радиусом зуба корпуса
        //public double b_r { get; set; } = 5; // зазор просвета между внешним радиусом крышки и внутренним радиусом зева корпуса
